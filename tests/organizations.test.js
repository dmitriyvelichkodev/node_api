    ...
    describe('# POST /api/organizations', function() {
        ...
        it('should fails due invalid format post data', function(done) {
            chai.request(app)
                ...
                .end((err, res) => {
                    expect(res.status)
                        .to.equal(httpStatus.INTERNAL_SERVER_ERROR);
                ...
                dbCleanUp()
                    ...
                    .then(() => {
                        return models.Relation.bulkCreate([
                            {
                                id: 1,
                                parentName: 'org1Level1',
                                daughterName: 'org1Level2',
                            }, {
                                id: 2,
                                parentName: 'org1Level1',
                                daughterName: 'org2Level2',
                            }, {
                                id: 3,
                                parentName: 'org1Level2',
                                daughterName: 'org1Level3',
                            }, {
                                id: 4,
                                parentName: 'org2Level2',
                                daughterName: 'org1Level3',
                            },
                        ]);
                    })
